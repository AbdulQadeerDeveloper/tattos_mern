...
// Create Tattoos:
exports.addTattooItems = upload.single('tattooImage'), asyncHandler(async (req, res) => {
...
exports.getTattoo = asyncHandler(async (req, res) => {
    try {
        const tattooData = await addTattoo.find().populate('categories', "name").populate('placement', "name").populate('comment');
