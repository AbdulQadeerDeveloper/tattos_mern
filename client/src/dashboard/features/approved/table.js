                        ...
                        <tbody>
                            {data?.map((tattoo, index) => (
                                <tr key={tattoo.id || index}>
                                    ...
                                    <td className='text-center align-content-center'><img src={`${BACKEND_URL_APPLICATION}/${tattoo?.tattooImage}`} alt={tattoo?.tattoosTitle} style={{ width: '50px', height: '50px' }} /></td>
