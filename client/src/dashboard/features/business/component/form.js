...
function BusinessForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await dispatch(submitBusinessForm(formData));
    ...
    return (
        <React.Fragment>
            ...
            <div className="modal-content" style={{ paddingBottom: "50px" }} id='formResponsive'>
                <div className="modal-body" id='fragemt_form'>
                    <div className="bg-img433">
                        <strong><h1>BUSINESS REGISTRATION</h1></strong>
                        <hr />
                        <form onSubmit={handleSubmit}>
                                ...
                                <div className='col-lg-9' style={{ marginLeft: "70px" }}>
                                    <div className='row'>
                                        <div className='col-md-6'>
                                            <div className="form-group mt-3">
                                                <label style={{ color: "#343a4c", paddingBottom: "10px" }}>Business Title: <span style={{ color: 'red' }}>*</span></label>
                                        ...
                                        <div className='col-md-6'>
                                            ...
                                            <div className="form-group mt-3">
                                                <label style={{ color: "#343a4c", paddingBottom: "10px" }}>Business Brand Name: <span style={{ color: 'red' }}>*</span></label>
                                    ...
                                    <div className='row'>
                                        <div className='col-md-6'>
                                            ...
                                            <div className="form-group">
                                                <label style={{ color: "#343a4c", paddingBottom: "10px" }}>Business E-mail: <span style={{ color: 'red' }}>*</span></label>
                                        ...
                                        <div className='col-md-6'>
                                            ...
                                            <div className="form-group">
                                                <label style={{ color: "#343a4c", paddingBottom: "10px" }}>Business Shop Address: <span style={{ color: 'red' }}>*</span></label>
                                    ...
                                    <div className='row'>
                                        <div className='col-md-12'>
                                            ...
                                            <div className="form-group mt-3">
                                                <label style={{ color: "#343a4c", paddingBottom: "10px" }}>Business Short Discription: <span style={{ color: 'red' }}>*</span></label><br />
                                    ...
                                    <div className='row'>
                                        <div className='col-md-12'>
                                            <div className="form-group mt-3">
                                                <label style={{ color: "#343a4c", paddingBottom: "10px" }}>Business Multiples Images: <span style={{ color: 'red' }}>*</span></label>
                                                <br />
                            ...
                            <div style={{ display: "flex", gap: "20px", justifyContent: 'end' }}>
                                ...
                                <span><Link to="/dashboard" className="btn pull-right">Cancel</Link></span>
                            </div>
